...
### Current Version: KAIZEN v06.0 · Last Updated: March 16, 2026
...
> Current version is KAIZEN v06.0.
> ```
...
- **Live URL:** `https://corvus-one.github.io/ciso-career-tracker/CISO_Tracker_kaizen_v06.html`
- **Current Version:** KAIZEN v06.0
...
```
CISO_Tracker_kaizen_v06.html        ← main app
...
`https://corvus-one.github.io/ciso-career-tracker/CISO_Tracker_kaizen_v06.html`
...
```json
{
  "start_url": "/ciso-career-tracker/CISO_Tracker_kaizen_v06.html",
